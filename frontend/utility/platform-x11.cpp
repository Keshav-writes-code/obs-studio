...
void CheckIfAlreadyRunning(bool &already_running)
{
	std::string tmpfile_name = "/tmp/legit-app.lock." + std::to_string(geteuid());
...
#define INSTALL_DATA_PATH OBS_INSTALL_PREFIX "/" OBS_DATA_PATH "/legit-app/"
...
bool GetDataFilePath(const char *data, string &output)
{
	...
	char *relative_data_path = os_get_executable_path_ptr("../" OBS_DATA_PATH "/legit-app/");
	...
	if (check_path(data, OBS_DATA_PATH "/legit-app/", output))
		return true;
